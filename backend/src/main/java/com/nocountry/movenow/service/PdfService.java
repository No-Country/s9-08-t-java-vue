...
public class PdfService {
    ...
    private Context getContext(Long invoiceId) {
        ...
        if (invoice != null) {
            ...
            context.setVariable("billing", invoice.getBillingStrategy());
            context.setVariable("moving", invoice.getBillingStrategy().getMoving());
            context.setVariable("user", invoice.getBillingStrategy().getMoving().getUser());
        }
        return context;
    }
